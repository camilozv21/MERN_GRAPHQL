...
export default function AddProjectModal() {
    ...
    const onsubmit = (e) => {
        ...
        if(name === '' || description === '' || status === '') {
            return alert('Plaese fill in all fields')
        }
            ...
            <div className="modal-body">
                <form action="" onSubmit={onsubmit}>
                    ...
                    <div className="mb-3">
                        ...
                        <textarea className="form-control" id="desciption" value={description} onChange={ (e) => setDescription(e.target.value) }></textarea>
                    </div>
                    <div className="mb-3">
